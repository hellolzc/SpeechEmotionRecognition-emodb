...
X_train, X_test, Y_train, Y_test, info_dict = dl_dataset.get_data_scaled(2018, 2, normlize=True, data_splitter=data_splitter)
...
result = main_experiment(dl_dataset, data_splitter, model, seeds=[2018,])
